...
void CallSegmentorVariance(int *Size, int *KMax, double *mu, double *Data, int *DataComp, int *Breakpoints, double *Parameters, double *Likelihood);
...
void CallSegmentorVarianceKeep(int *Size, int *KMax, double *mu, double *Data, int *DataComp, int *Breakpoints, double *Parameters, double *Likelihood,double *Cost, int *Pos);
